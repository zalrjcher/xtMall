            ...
            <div class="mobile">
              ...
              <div class="goodPrice">
                <div>
                  ...
                  <input  @click="joinShoppingCart(item.id,1)" type="button" class="btn2" style="background-color: #678ee7;border: 1px solid #5c81e3; background-image: linear-gradient(180deg,#678ee7,#5078df); color: white" value="加入购物车"/>
                </div>
                <p class="p">
